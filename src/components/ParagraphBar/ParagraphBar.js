...
function ParagraphBar() {
    return (
        <div className="paragraphbar" id="paragraph">
            <div className="paragraphbar__overlay">
                <h3 className="paragraphbar__title">
                    CLEARING LAND FOR FARMS FERROL
                </h3>
                <p className="paragraph">
                    <strong>1</strong> Rainforests are disappearing in tropical areas around the world. They are being cut
                    ...
                    (33) __ solutions to these problems. Unfortunately, progress in this area has been
                    very slow.
                    2 According to World Bank statistics, many developing countries, such as Brazil,
                    Ecuador, and Indonesia, had lost almost half of (34) __ rainforests by 1991.
